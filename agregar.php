      ...
      <div class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1"><!--post_details--><!--post_details_options_json--><!--{"source":""}--><!--/post_details_options_json--><!--blog_post-->
        <div class="u-container-style u-expanded-width u-post-details u-post-details-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1"><!--blog_post_image-->
            <div id="preview" alt="" class="u-blog-control u-expanded-width u-image u-image-default u-image-1"></div>
            <input type="file" name="imagen" id="imagen">
            <h2 class="u-blog-control u-text u-text-1"><input type="text" name="title" required id="title" placeholder="titulo"></h2><!--/blog_post_header--><!--blog_post_metadata-->
            ...
            <textarea name="editor" id="editor" cols="30" rows="10">
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatem, accusantium qui laboriosam voluptates vel rerum necessitatibus eveniet ducimus sequi consequuntur ea quod debitis perspiciatis aut voluptatibus cumque explicabo error laborum.</p>
            </textarea>
